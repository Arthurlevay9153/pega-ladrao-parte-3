...
function setup() {
  ...
  dispensa3 = createSprite(575, 200, 10, 10);
...
function draw() {
  ...
  if (ladrao.collide(dispensa3)) {
    if (keyDown("SPACE")) {
      textBox = createImg("assets/textbox.png"); //criando a imagem e qual é seu visual

      textBox.size(700, 200); //size = tamanho do texto/imagem

      textBox.position(560, 550); //position = posicao do texto/imagem
    }
  } else {
    textBox = null;
  }
